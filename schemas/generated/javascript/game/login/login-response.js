...
class LoginResponse {
    ...
    static getRootAsLoginResponse(bb, obj) {
        return (obj || new LoginResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsLoginResponse(bb, obj) {
    ...
    static startLoginResponse(builder) {
        builder.startObject(1);
    }
    static addUid(builder, uid) {
        builder.addFieldInt32(0, uid, 0);
    }
    static endLoginResponse(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createLoginResponse(builder, uid) {
