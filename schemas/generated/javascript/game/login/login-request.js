...
class LoginRequest {
    ...
    static getRootAsLoginRequest(bb, obj) {
        return (obj || new LoginRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsLoginRequest(bb, obj) {
        bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        return (obj || new LoginRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static startLoginRequest(builder) {
        builder.startObject(0);
    }
    static endLoginRequest(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createLoginRequest(builder) {
