...
const player_data_js_1 = require("../../game/player/player-data.js");
class EnterGameResponse {
    ...
    static getRootAsEnterGameResponse(bb, obj) {
        return (obj || new EnterGameResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsEnterGameResponse(bb, obj) {
    ...
    visiblePlayersLength() {
        const offset = this.bb.__offset(this.bb_pos, 6);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    }
    static startEnterGameResponse(builder) {
        builder.startObject(2);
    }
    static addSelfPlayer(builder, selfPlayerOffset) {
        builder.addFieldOffset(0, selfPlayerOffset, 0);
    }
    static addVisiblePlayers(builder, visiblePlayersOffset) {
        builder.addFieldOffset(1, visiblePlayersOffset, 0);
    }
    static createVisiblePlayersVector(builder, data) {
    ...
    static startVisiblePlayersVector(builder, numElems) {
        builder.startVector(4, numElems, 4);
    }
    static endEnterGameResponse(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createEnterGameResponse(builder, selfPlayerOffset, visiblePlayersOffset) {
