...
class AttachedData {
    ...
    static getRootAsAttachedData(bb, obj) {
        return (obj || new AttachedData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsAttachedData(bb, obj) {
    ...
    static startAttachedData(builder) {
        builder.startObject(1);
    }
    static addPos(builder, posOffset) {
        builder.addFieldOffset(0, posOffset, 0);
    }
    static endAttachedData(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createAttachedData(builder, posOffset) {
