...
class PlayerMoveResponse {
    ...
    static getRootAsPlayerMoveResponse(bb, obj) {
        return (obj || new PlayerMoveResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsPlayerMoveResponse(bb, obj) {
    ...
    static startPlayerMoveResponse(builder) {
    ...
    static endPlayerMoveResponse(builder) {
