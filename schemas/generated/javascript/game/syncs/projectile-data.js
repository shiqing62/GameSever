...
class ProjectileData {
    ...
    static getRootAsProjectileData(bb, obj) {
        return (obj || new ProjectileData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsProjectileData(bb, obj) {
    ...
    static startProjectileData(builder) {
    ...
    static addLifeTime(builder, lifeTime) {
        builder.addFieldFloat32(2, lifeTime, 0.0);
    }
    static endProjectileData(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createProjectileData(builder, directionOffset, speed, lifeTime) {
